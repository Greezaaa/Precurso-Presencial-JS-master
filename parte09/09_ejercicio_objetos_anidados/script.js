...
base = randomObject.them.speed.past.program.grade.addition.whose.national.cannot;
//show value of board
console.log(base.board);
//get name and save it
base.name = prompt('Enter your name')
// show introduced name
